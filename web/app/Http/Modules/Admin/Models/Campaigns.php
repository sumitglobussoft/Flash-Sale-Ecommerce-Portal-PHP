...
class Campaigns extends Model
{
    ...
    protected $fillable = ['campaign_id', 'campaign_name', 'by_user_id', 'for_shop_id', 'campaign_type', 'campaign_banner', 'discount_type', 'discount_value', 'available_from', 'available_upto','extended_end_time','for_category_ids', 'for_product_ids', 'campaign_status', 'status_set_by'];
